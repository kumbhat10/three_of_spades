...
////region Player Info Listener changed to single value event listener
//
//        try {
//        refRooms.addListenerForSingleValueEvent(object : ValueEventListener {override fun onCancelled(errorDataLoad: DatabaseError) {}
//        override fun onDataChange(dataLoad: DataSnapshot) {
//        p1 = dataLoad.child("P").child("p1").value.toString()
//        p2 = dataLoad.child("P").child("p2").value.toString()
//        p3 = dataLoad.child("P").child("p3").value.toString()
//        p4 = dataLoad.child("P").child("p4").value.toString()
//        p5 = dataLoad.child("P").child("p5").value.toString()
//        p6 = dataLoad.child("P").child("p6").value.toString()
//        p7 = dataLoad.child("P").child("p7").value.toString()
//        for(i in 0..6) {
//        val j = i+1
...
//        animateElements()
//        resetVariables()
//        findViewById<ScrollView>(R.id.scrollViewScore).visibility = View.INVISIBLE
//        for(i in 0..6) {
//        findViewById<TextView>(refIDMappedTextView[i]).text = playerName(i+1)
//        }
//        shufflingWindow(gameStateChange = true) // gameStateChange = change gamestate to 2 after shuffling
//        }
//        if (gameState == 2) {
//        soundUpdate.start()
...
//        if(scoreSheetNotUpdated) scoreBoardTable(display = false,data = listOf("#",p1,p2,p3,p4,p5,p6,p7))
//        scoreSheetNotUpdated = false
//        refGameData.child("S").addListenerForSingleValueEvent(object: ValueEventListener{
//        override fun onCancelled(p0: DatabaseError) {}
//        override fun onDataChange(p0: DataSnapshot) {
//        if(scoreList != p0.value as List<Int>){
...
//                                        })
//                                        if(from == "p1") {
////                       Handler().postDelayed({startNextGame()},1000)
//                                        findViewById<HorizontalScrollView>(R.id.horizontalScrollView).foreground = ColorDrawable(ContextCompat.getColor(applicationContext,R.color.inActiveCard))
//        findViewById<ImageView>(R.id.startNextRoundButton).visibility = View.VISIBLE
//        findViewById<ImageView>(R.id.startNextRoundButton).startAnimation(AnimationUtils.loadAnimation(applicationContext,R.anim.anim_scale_infinite))
//        }
//        }
//        }}
//// endregion
...
//        }
//        // endregion
//// region Individual Points listener
...
//        partnerListener1 = object : ValueEventListener {override fun onCancelled(errorDataLoad: DatabaseError) {}
//        override fun onDataChange(data: DataSnapshot) {
//        if(buFound1 != data.child("s1").value.toString().toInt() && buFound1!=1) soundSuccess.start()
//        buPlayer1 = data.child("b1").value.toString().toInt()
//        buFound1  = data.child("s1").value.toString().toInt()
//        if(buPlayer1 != 0 && buFound1 ==1) findViewById<TextView>(R.id.textViewP1).text = playerName(buPlayer1)
//        displayPartnerIcon()
//        }
//        }
////            endregion
...
//        partnerListener2 = object : ValueEventListener {override fun onCancelled(errorDataLoad: DatabaseError) {}
//        override fun onDataChange(data: DataSnapshot) {
//        if(buFound2 != data.child("s2").value.toString().toInt() && buFound2!=1) soundSuccess.start()
//        buPlayer2 = data.child("b2").value.toString().toInt()
//        buFound2  = data.child("s2").value.toString().toInt()
//        if(buPlayer2 != 0 && buFound2 ==1) findViewById<TextView>(R.id.textViewP2).text = playerName(buPlayer2)
//        displayPartnerIcon()
//        }
//        }
////            endregion
...
//        override fun onFinish() {
//        soundTimerFinish.start()
//        if(bidingStarted) write("Bid/BS/p$playerTurn",0) // pass the bid if times up
...
//        if(bidingStarted) centralText("    Time's Up !!  \n You cannot bid anymore",2500)
//        bidingStarted = true
//        }
//        }
////        endregion
...
//        findViewById<TextView>(R.id.textViewBidValue).text = getString(R.string.bidValue1)
...
//        findViewById<ImageView>(R.id.startNextRoundButton).clearAnimation()
//        findViewById<ImageView>(R.id.startNextRoundButton).visibility = View.INVISIBLE
//
...
//        textViewCenterPoints.visibility = View.INVISIBLE
//        }
//        }
...
//        findViewById<TextView>(refIDMappedTextView[i]).text = playerName(j) + "\n   $bidTeamScore / $bidValue"
//        else findViewById<TextView>(refIDMappedTextView[i]).text = playerName(j) + "\n   ${pointsList.sum()-bidTeamScore} / ${705 - bidValue}"
//        }
//        var tt1 = 0
//        var tt2 = 0
//        if(buFound1==1)                         tt1 = pointsList[buPlayer1-1]
//        if(buFound2==1 && buPlayer1!=buPlayer2) tt2 = pointsList[buPlayer2-1] // if not same partners then only add other points
//        val bidTeamScoreFinal   = pointsList[bidder-1] + tt1 + tt2
//        if(bidTeamScoreFinal >= bidValue) {
...
//        val pointsListTemp = mutableListOf<Int>(gameNumber,0,0,0,0,0,0,0)
//        for(i in 1..7){
//        if(i == bidder )  pointsListTemp[i] = bidValue*2
//        else if( (i == buPlayer1 && buFound1!=0) || (i == buPlayer2 && buFound2!=0)) pointsListTemp[i] = bidValue
//        }
//        write("S",pointsListTemp) // 0-bidder won, 1 - defenders won
//        write("GS", 6)
//        }
//        }
//        else if (buFound1==1 && buFound2==1 && (pointsList.sum()-bidTeamScore) >= (705 - bidValue) ){
//        refGameData.child("RO").removeEventListener(roundListener)
//        clearAllAnimation()
...
//        val pointsListTemp = mutableListOf<Int>(gameNumber,0,0,0,0,0,0,0)
//        for(i in 1..7){
//        if(i == bidder )  pointsListTemp[i] = -1*bidValue
//        else if( i != buPlayer1  && i != buPlayer2 ) pointsListTemp[i] = bidValue
//        }
//        write("S",pointsListTemp) // 0-bidder won, 1 - defenders won
//        write("GS", 6)
//        }
...
////                        toastCenter(playerTurn.toString())
...
//        if(playerTurn != bidder) checkPartner(cardSelected, playerTurn)
...
//        startNextRound()
//        }else{
//        centralText("Waiting for ${playerName(roundWinner)} to play next card",2000)
//        }
...
////        findViewById<LinearLayout>(R.id.imageGalleryScore).invalidate()
////        findViewById<LinearLayout>(R.id.imageGalleryScore).requestLayout()
...
//        return suit
//        }
//private fun displaySelfCards(view: View = View(applicationContext),  animations: Boolean = false, filter: Boolean = false) {
...
//        })
//        if (animations) {
//        viewTemp.startAnimation(AnimationUtils.loadAnimation(applicationContext, R.anim.slide_down_in))
//        }
...
//        if(!bidingStarted) {
//        centralText("${playerName(playerTurn)} will start bidding",5000) //display message only first time
//        }
//        soundUpdate.start()
...
//        when(view.tag){
//        "pass"-> {
//        if(bidingStarted) write("Bid/BS/$from", 0)
//        if(bidingStarted) centralText("    Time's Up !!  \n You cannot bid anymore",2500)
//        }
//        "5"->{
...
//        findViewById<LinearLayout>(R.id.imageGallery).setBackgroundColor(ContextCompat.getColor(applicationContext,R.color.layoutBackground))
//        findViewById<LinearLayout>(R.id.imageGallery).clearAnimation()
//        findViewById<GifImageView>(refIDMappedImageView[bidder -1]).setBackgroundColor(ContextCompat.getColor(applicationContext, R.color.progressBarPlayer4)) // highlight bidder winner
//        }
//
//private fun centralText(message: String, displayTime: Int=3000){
...
//        findViewById<HorizontalScrollView>(R.id.horizontalScrollView).foreground = ColorDrawable(ContextCompat.getColor(applicationContext,R.color.layoutBackground))
...
//        if(scoreSheetNotUpdated) scoreBoardTable(display = false,data = listOf("#",p1,p2,p3,p4,p5,p6,p7))
//        scoreSheetNotUpdated = false
////            findViewById<ScrollView>(R.id.scrollViewScore).invalidate()
////            findViewById<LinearLayout>(R.id.imageGalleryScore).invalidate()
//        findViewById<ScrollView>(R.id.scrollViewScore).visibility = View.VISIBLE
//        findViewById<ScrollView>(R.id.scrollViewScore).startAnimation(AnimationUtils.loadAnimation(applicationContext, R.anim.slide_up_in_score_table))
//        }
//        }
