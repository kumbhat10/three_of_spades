...
class PlayersReference {
    ...
    val refIDValuesTextViewScoreSheet = listOf(R.id.gameNumber,R.id.player1,R.id.player2,R.id.player3,R.id.player4, // size 8 - sheet of score
    ...
    fun refIDMappedOnlineIconImageView(player: String): List<Int>{
        return createRefID(player,refIDValuesOnlineIconImageView)
    }
    fun refIDMappedPartnerIconImageView(player: String): List<Int>{
        return createRefID(player,refIDValuesPartnerIconImageView)
    }
