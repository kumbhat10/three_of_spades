...
//        if(BuildConfig.DEBUG) Picasso.get().setIndicatorsEnabled(true)
    ...
    private fun setDataListPS(): ArrayList<PlayerStatsItem> {
        ...
        arrayList.add(PlayerStatsItem(R.drawable.trophy, "Games Won", (nGamesWon + nGamesWonBot).toString()))
        arrayList.add(PlayerStatsItem(R.drawable.target, "Games Bid", (nGamesBid + nGamesBidBot).toString()))
