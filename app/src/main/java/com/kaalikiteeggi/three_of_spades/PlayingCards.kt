...
//     region Cards Drawable
    val cardsDrawablePartner7 =  listOf( R.drawable.s2, R.drawable.s3, R.drawable.s4, R.drawable.s5, R.drawable.s6,
    ...
    val cardsDrawable4 =  listOf( R.drawable.s2, R.drawable.s3, R.drawable.s4, R.drawable.s5, R.drawable.s6, //
        ...
        R.drawable.c8 ,R.drawable.c9 ,R.drawable.c10 ,R.drawable.c11 ,R.drawable.c12 ,R.drawable.c13 ,R.drawable.c14 ,
        R.drawable.d2 ,R.drawable.d3 ,R.drawable.d4 ,R.drawable.d5 ,R.drawable.d6 ,R.drawable.d7 ,R.drawable.d8 ,
        R.drawable.d9 ,R.drawable.d10 ,R.drawable.d11 ,R.drawable.d12 ,R.drawable.d13 ,R.drawable.d14 )
    ...
    val cardsIndexSortedPartner7 = listOf(1,12,24,36,48,	11,23,35,47,	10,22,34,46,	9,21,33,45,	8,20,32,44, 7,19,31,43, 6,18,30,42,
    5,17,29,41, 4,16,28,40, 3,15,27,39, 2,14,26,38 , 13,25,37, 0)

    val cardsIndexSortedPartner4 = listOf(1,12,	25,	38,	51,
        11,24,37,50,
        10,23,36,49,
        9,22,35,48,
        8,21,34,47,
    ...
    //    endregion
//  region Card Points
    val cardsPointsPartner7 = listOf(0,30,0,5,0,0,0,0,10,15,15,15,20,
         0,0,5,0,0,0,0,10,15,15,15,20,
         0,0,5,0,0,0,0,10,15,15,15,20,
         0,0,5,0,0,0,0,10,15,15,15,20)

    val cardsPoints4 = listOf(0,30,0,5,0,0,0,0,10,15,15,15,20,
        0,0,0,5,0,0,0,0,10,15,15,15,20,
        0,0,0,5,0,0,0,0,10,15,15,15,20,
        0,0,0,5,0,0,0,0,10,15,15,15,20,
    0,0)  // add 2 extra zeros for card index 52 and 53
...
//     region Card Suit
    private val cardSuit7 = listOf("S","S","S","S","S","S","S","S","S","S","S","S","S",
    "H","H","H","H","H","H","H","H","H","H","H","H",
    "C","C","C","C","C","C","C","C","C","C","C","C",
      "D","D","D","D","D","D","D","D","D","D","D","D")

    val cardSuit4 = listOf("S","S","S","S","S","S","S","S","S","S","S","S","S",
