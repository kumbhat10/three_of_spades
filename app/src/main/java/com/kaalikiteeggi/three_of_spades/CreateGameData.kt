...
class CreateGameData(uid: String, selfName: String) {
	...
	private val randPlayerTurn7 = Random.nextInt(1, 7)
	private val randPlayerTurn4 = Random.nextInt(1, 4)
	...
	val gameData7 = mutableMapOf("A_Date" to SimpleDateFormat("yyyyMMdd").format(Date())
        ...
        "A_Name" to selfName,
        "n" to 7,
        "Bid" to mutableMapOf("BV" to 350, "BT" to randPlayerTurn7, "BB" to randPlayerTurn7, "BS" to mutableMapOf("p1" to 1, "p2" to 1, "p3" to 1, "p4" to 1, "p5" to 1, "p6" to 1, "p7" to 1)),
		"BU" to mutableMapOf("b1" to "", "b1s" to "", "b2" to "", "b2s" to ""), "BU1" to mutableMapOf("b1" to 8, "s1" to 0),  // b1 = player number = 8 means not declared. b1s = 0 ND, 2 Not sure, 1 Locked
		...
		"OL" to mutableMapOf("p1" to 0, "p2" to 0, "p3" to 0, "p4" to 0, "p5" to 0, "p6" to 0, "p7" to 0), "R" to 1, "RO" to mutableMapOf("T" to 1, "P" to 0, "R" to ""), // t game turn, p player turn, R is rung
	...
	val gameDataDummy7 = mutableMapOf("ADate" to SimpleDateFormat("yyyyMMdd").format(Date())
		...
		"OL" to mutableMapOf("p1" to 0, "p2" to 0, "p3" to 0, "p4" to 0, "p5" to 0, "p6" to 0, "p7" to 0), "R" to 1,
		"CH" to mutableMapOf("p1" to cardsShuffled7.slice(0..13)
			.sortedBy { it }, "p2" to cardsShuffled7.slice(14..27)
			.sortedBy { it }, "p3" to cardsShuffled7.slice(28..41)
			.sortedBy { it }, "p4" to cardsShuffled7.slice(42..55)
		...
		"G" to mutableMapOf("b1" to 8, "bs1" to 0, "b2" to 8, "bs2" to 0,
		"CT" to listOf(99,99,99,99,99,99,99),
		"SC" to listOf(0,0,0,0,0,0,0),
		"rT" to 1, "rPT" to 0, "rN" to 0, "Tr" to "", "rTr" to ""),
//		"BU1" to mutableMapOf("b1" to 8, "s1" to 0),  // b1 = player number = 8 means not declared. b1s = 0 ND, 2 Not sure, 1 Locked
//		"BU2" to mutableMapOf("b2" to 8, "s2" to 0),  // b1 = player number = 8 means not declared. b1s = 0 ND, 2 Not sure, 1 Locked
//		"CT" to mutableMapOf("p1" to 83, "p2" to 73, "p3" to 31, "p4" to 45, "p5" to 67, "p6" to 78, "p7" to 89), "GS" to 1, // 0 means joining state
...
//		"Tr" to ""
	...
	val gameData4 = mutableMapOf("ADate" to SimpleDateFormat("yyyyMMdd").format(Date())
        ...
        "A_Name" to selfName,
        "n" to 4,
        "Bid" to mutableMapOf("BV" to 175, "BT" to randPlayerTurn4, "BB" to randPlayerTurn4, "BS" to mutableMapOf("p1" to 1, "p2" to 1, "p3" to 1, "p4" to 1)),
		"BU" to mutableMapOf("b1" to "", "b1s" to "", "b2" to "", "b2s" to ""),
		"BU1" to mutableMapOf("b1" to 8, "s1" to 0),  // b1 = player number = 8 means not declared. b1s = 0 ND, 2 Not sure, 1 Locked
		...
		"OL" to mutableMapOf("p1" to 0, "p2" to 0, "p3" to 0, "p4" to 0), "R" to 1, "RO" to mutableMapOf("T" to 1, "P" to 0, "R" to ""), // t game turn, p player turn, R is rung
